...
const Header = ({ toggleFolderPanel, setToggleFolderPanel }) => {
  ...
  return (
    <div className="text-slate-500 border w-[100%] mb-3 rounded p-2 px-4 flex justify-between items-center relative shadow-lg">
      <div className="w-[100%] lg:w-[70%] flex justify-between">
        <div className="flex  items-center ">
          <span role={"button"} onClick={() => setToggleFolderPanel(!toggleFolderPanel)}>
            <FiMenu />
          </span>
          <button className="flex ml-5 gap-2 items-center bg-[#0001ff] rounded text-white px-5 py-1">
            <span>
              <FiMail />
            </span>
        ...
        <div className="w-[70%] hidden md:flex justify-evenly items-center">
          <div className="flex gap-10 text-[18px]">
            <span role={"button"} className="">
              <RiDeleteBinLine />
            </span>
            <span role={"button"} className="text-green-800">
              <RiArchiveLine />
            </span>
            <span role={"button"} className="text-red-800">
              <RiErrorWarningLine />
            </span>
            <span role={"button"} className="text-blue-800">
              <RiFolderSharedLine />
            </span>
          </div>
          <div className="hidden lg:flex gap-10 text-[18px]">
            <span role={"button"} className="text-purple-800">
              <BsReply />
            </span>
            <span role={"button"} className="text-purple-800">
              <BsReplyAll />
            </span>
            <span role={"button"} className="text-[#0001ff] flip-hor">
              <BsReply />
            </span>
          </div>
        </div>
      ...
      >
        <div className="md:hidden border-b-[1px] border-slate-300 pl-4">
          ...
          <span role={"button"} className="flex items-center gap-2 my-2">
            <RiDeleteBinLine />
            <span className="text-slate-700">Delete</span>
          </span>
          <span
            role={"button"}
            className="text-green-800 flex items-center gap-2  my-2"
          >
            <RiArchiveLine />
          ...
          <span
            role={"button"}
            className="text-red-800 flex items-center gap-2 my-2"
          >
            <RiErrorWarningLine />
          ...
          <span
            role={"button"}
            className="text-blue-800 flex items-center gap-2 my-2"
          >
            <RiFolderSharedLine />
        ...
        <div className="lg:hidden  border-b-[1px] border-slate-300 pl-4">
          ...
          <span
            role={"button"}
            className="flex items-center gap-2 my-2 text-purple-800"
          >
            <BsReply />
          ...
          <span
            role={"button"}
            className="text-green-800 flex items-center gap-2  my-2 text-purple-800"
          >
            <BsReplyAll />
          ...
          <span
            role={"button"}
            className="flex items-center gap-2 my-2 text-[#0001ff] "
          >
